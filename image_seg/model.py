...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
                  use_mini_mask=False):
    """Load and return ground truth train for an image (image, mask, bounding boxes).
...
def data_generator(dataset, config, shuffle=True, augment=False, augmentation=None,
    ...
    dataset: The Dataset object to pick train from
    config: The model config object
...
class MaskRCNN:
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        layer_regex = {
            ...
            "heads": r"(image_seg\_.*)|(rpn\_.*)|(fpn\_.*)",
            # From a specific Resnet stage and up
            "3+": r"(res3.*)|(bn3.*)|(res4.*)|(bn4.*)|(res5.*)|(bn5.*)|(image_seg\_.*)|(rpn\_.*)|(fpn\_.*)",
            "4+": r"(res4.*)|(bn4.*)|(res5.*)|(bn5.*)|(image_seg\_.*)|(rpn\_.*)|(fpn\_.*)",
            "5+": r"(res5.*)|(bn5.*)|(image_seg\_.*)|(rpn\_.*)|(fpn\_.*)",
            # All layers
            "all": ".*",
        }
    ...
    def mold_inputs(self, images):
        ...
        image_metas: [N, length of meta train]. Details about each image.
    ...
    def detect_molded(self, molded_images, image_metas, verbose=0):
        ...
        image_metas: image meta train, also retruned by load_image_gt()
