...
class PWCNetWrapper:
    ...
    def infer_flow_field(self, img1, img2, divisor: float = 64., scaled=False):
        ...
        :param scaled: whether to scale inputs (and outputs) internally
        ...
        if scaled:
            ...
            for i in range(len(img_all)):
                img_all[i] = cv2.resize(img_all[i], dsize=(W_, H_))

        # set up inputs for pytorch
