...
print('time to preprocess images: {} s'.format(time.time() - start_time))
start_time = time.time()
...
print('time to create network: {} s'.format(time.time() - start_time))
start_time = time.time()
...
print('time to run network: {} s'.format(time.time() - start_time))
start_time = time.time()
...
print('time to postprocess image: {} s'.format(time.time() - start_time))
